<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RM_VIEW_ABM.ascx.cs" Inherits="RM_VIEW_ABM" %>

<asp:DataList ID="DataList1" runat="server" CellPadding="4" 
    ForeColor="#333333"
    RepeatDirection="Horizontal" RepeatColumns="1" 
    style="margin-left: 0px; margin-bottom: 0px; margin-top: 54px;" 
    Height="485px" Width="2034px" 
    ...
    <ItemTemplate>
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       ...
       <td align="left">
       <a href="AREA_ALLOT_T0_AM.aspx?staffid=<%#DataBinder.Eval(Container.DataItem,"staffid") %>">ALLOT AREA</a>
       </td>
